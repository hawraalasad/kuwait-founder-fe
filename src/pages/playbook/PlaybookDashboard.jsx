    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      ...
      >
        <div className="w-20 h-20 bg-kuwait-gold/20 rounded-full flex items-center justify-center mx-auto mb-6">
          <Book className="w-10 h-10 text-kuwait-gold" />
        </div>
        ...
        <p className="text-medium-gray mb-6">
          {isRTL
            ? 'نحن نعمل بجد لإعداد محتوى الدليل. ترقبوا التحديثات!'
            : 'We\'re working hard to prepare the playbook content. Stay tuned for updates!'
          }
        </p>
